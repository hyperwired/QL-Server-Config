...
+set qlx_plugins DEFAULT, tomtec_logic, tp_fun, fun, balance, commlink, aliases, votestats, custom_votes, votemanager, branding, q3resolver, connect_quotes, servers \
