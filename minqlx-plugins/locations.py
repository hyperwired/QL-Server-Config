...
class locations(minqlx.Plugin):
    def __init__(self):
        self.add_command(("loc", "location"), self.cmd_location, 5, usage="<id>")
    ...
    def cmd_location(self, player, msg, channel):
        ...
        try:
            ...
            player.tell("^1Invalid Client ID.^7 Enter a valid client ID to see their approximate location.")
            return
