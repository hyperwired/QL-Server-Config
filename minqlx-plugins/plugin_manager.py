...
class plugin_manager(minqlx.Plugin):
    ...
    def cmd_load(self, player, msg, channel):
        if len(msg) < 2:
            ...
            try:
                ...
                channel.reply("Plugin ^4{} ^7has been successfully loaded."
                    .format(msg[1]))
            except Exception as e:
                channel.reply("Plugin ^4{} ^7has failed to load: {} - {}"
    ...
    def cmd_unload(self, player, msg, channel):
        if len(msg) < 2:
            ...
            try:
                ...
                channel.reply("Plugin ^4{} ^7has been successfully unloaded."
                    .format(msg[1]))
            except Exception as e:
                channel.reply("Plugin ^4{} ^7has failed to unload: {} - {}"
                    .format(msg[1], e.__class__.__name__, e))
                minqlx.log_exception(self)
        ...
        if len(msg) < 2:
            ...
            def f():
                try:
                    ...
                    channel.reply("Plugin ^4{} ^7has been successfully reloaded."
                        .format(msg[1]))
                except Exception as e:
                    channel.reply("Plugin ^4{} ^7has failed to reload: {} - {}"
                        .format(msg[1], e.__class__.__name__, e))
                    minqlx.log_exception(self)
    ...
    def cmd_loadall(self, player, msg, channel):
        ...
        def f():
            ...
            channel.reply("Successfully loaded all plugins in ^4qlx_plugins^7.")
        f()
